...
namespace Polyteks.Katman.DAL.Concrete.EntityFramework
{
    ...
    public partial class CozguRaporSablon
    {
        public int CozguRaporSablonID { get; set; }
        ...
        public Nullable<int> ToplamRaporTelAdedi { get; set; }
        public Nullable<int> ToplamZeminTelAdedi { get; set; }
        ...
        public Nullable<int> UretimBantAdedi { get; set; }
        public string CozguGrupSayacNo { get; set; }
        public string CozguVaryantSayacNo { get; set; }
